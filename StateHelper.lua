...
upd = {}
url_upd = 'https://raw.githubusercontent.com/KaneScripter/StateHelper/main/StateHelper.lua'
upd_status = 0
...
function update_check()
	upd_status = 1
	local upd_txt_info = 'https://raw.githubusercontent.com/KaneScripter/StateHelper/main/Information.json'
